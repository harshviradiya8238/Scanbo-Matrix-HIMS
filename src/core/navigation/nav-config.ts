...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          {
            id: 'doctor-orders-all',
            label: 'Rx & Clinical Orders',
            iconName: 'Medication',
            route: '/doctor/orders',
            type: 'item',
            requiredPermissions: ['clinical.read'],
    ...
    items: [
      {
        ...
        children: [
          ...
          {
            id: 'clinical-welcome-kiosk',
            label: 'Welcome Kiosk',
            iconName: 'TouchApp',
            route: '/clinical/modules/welcome-kiosk',
            type: 'item',
            requiredPermissions: ['clinical.kiosk.read'],
            order: 4,
          },
        ],
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        type: 'item',
        requiredPermissions: ['financial-assistance.read'],
        order: 6,
      },
    ],
  },
