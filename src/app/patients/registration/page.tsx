...
import { PatientRegistrationFormData } from "@/src/screens/patients/PatientRegister/types/patient-registration.types";
import { useState } from "react";
import CommonRegistrationForm, {
  RegistrationEntityMode,
} from "@/src/screens/patients/PatientRegister/CommonRegistrationForm";
...
export default function RegistrationPage() {
  ...
  const registrationMode: RegistrationEntityMode = isFamilyFlow
    ? "family"
    : "patient";
  ...
  return (
    <PageTemplate
      title={
        isFamilyFlow ? "Family Member Registration" : "Patient Registration"
      }
