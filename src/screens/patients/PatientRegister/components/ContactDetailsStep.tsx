      ...
      >
        ...
        >
          ...
          <Stack direction="row" spacing={0.75} flexWrap="wrap">
            ...
            <Chip
              size="small"
              label={isIndia ? "Address (India)" : "Address (International)"}
              sx={chipSx}
            />
          </Stack>
        </Stack>
        ...
        {isIndia ? (
          ...
          <Box sx={{ mt: 1.6 }}>
            <Alert severity="info" sx={{ mb: 1.2 }}>
              Capture both home country address and local stay details in India
            ...
            <Grid container spacing={1.35}>
              ...
              <Grid xs={12} md={8}>
                <FormTextField
                  name="localAddressIndia"
                  label="Local Address in India"
                />
              </Grid>
              <Grid xs={12} md={4}>
                <FormTextField
                  name="indiaStayDuration"
                  label="India Stay Duration"
