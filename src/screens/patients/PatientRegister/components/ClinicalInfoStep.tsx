      ...
      >
        ...
        <Box sx={{ p: 2.25 }}>
          <Grid container spacing={1.35}>
            ...
            <Grid xs={12} md={4}>
              <FormSelect
                name="wardBedPreference"
                label="Ward / Bed Preference"
                options={wardPreferenceOptions}
              />
            </Grid>
            <Grid xs={12} md={4}>
              <Box sx={{ pt: 1 }}>
      ...
      >
        ...
        <Box sx={{ p: 2.25 }}>
          <Stack spacing={0.4}>
            <FormCheckbox
              name="consentVerbal"
              label="Patient / Guardian has given verbal consent for treatment"
            />
            <FormCheckbox
              name="consentWritten"
              label="Written General Consent Form received and filed"
            />
            {isIndia ? (
              <FormCheckbox
            ...
            />
            <FormCheckbox
              name="consentIdAttached"
              label="Photo ID copies scanned and attached"
            />
          </Stack>
