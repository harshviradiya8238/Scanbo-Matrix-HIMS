    ...
    <Box>
      ...
      <Stack direction="row" spacing={1} sx={{ mb: 2 }} flexWrap="wrap">
        ...
        <Button
          variant="outlined"
          size="small"
          onClick={() => addSampleId && onAddSample(addSampleId)}
          ...
          <Stack spacing={2}>
            <WorksheetDetailView
              ...
              onAddSample={(sampleId) => {
                ...
                setSnackbar({
                  open: true,
                  message: "Sample added to worksheet.",
                  severity: "success",
                });
              }}
              onSubmitForVerification={() => {
          ...
          >
            {worksheets.map((w) => {
              ...
              return (
                <Box
                  key={w.id}
                  sx={{ ...lab.cardSx, p: 2, cursor: "pointer" }}
                ...
                >
                  ...
                  >
                    ...
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        router.push(`/lab/worksheets?id=${w.id}`);
                      }}
                    >
                      Manage
                    </Button>
