...
import CommonTabs, { CommonTabItem } from '@/src/ui/components/molecules/CommonTabs';
...
const PPE_CHECKLIST: PpeChecklistItem[] = [
  { id: 'ppe-1', label: 'Gloves — non-sterile examination gloves', checked: true, role: 'Nurse Staff' },
  { id: 'ppe-2', label: 'Gown — disposable isolation gown', checked: true, role: 'Ward Staff' },
  { id: 'ppe-3', label: 'N95 / FFP2 Respirator (airborne cases)', checked: false, role: 'Nurse Staff' },
  { id: 'ppe-4', label: 'Isolation sign posted at room door', checked: true, role: 'Housekeeping' },
  { id: 'ppe-5', label: 'Dedicated equipment assigned (BP, steth)', checked: false, role: 'Ward Staff' },
  { id: 'ppe-6', label: 'Hand sanitizer station at room entrance', checked: true, role: 'Housekeeping' },
];
...
const AVAILABLE_ISOLATION_ROOMS: AvailableIsolationRoom[] = [
  { id: 'air-1', room: 'A-06', unit: 'Ward 1B', type: 'Contact', status: 'Available' },
  { id: 'air-2', room: 'A-04', unit: 'Ward 1B', type: 'Droplet', status: 'Available' },
  { id: 'air-3', room: 'A-08', unit: 'Ward 3A', type: 'Contact', status: 'Available' },
  { id: 'air-4', room: 'B-02', unit: 'ICU', type: 'Airborne', status: 'Available' },
  { id: 'air-5', room: 'C-01', unit: 'Ward 1B', type: 'Standard', status: 'Available' },
];
...
const LAB_FEED_ITEMS: LabFeedItem[] = [
  { id: 'lf-1', title: 'MRSA - Blood culture', patient: 'Rahul Menon', bed: 'B-12', status: 'pending' },
  { id: 'lf-2', title: 'C.diff toxin +ve - Stool', patient: 'Sneha Patil', bed: 'A-04', status: 'auto-flagged' },
  { id: 'lf-3', title: 'Screen clear - CBC', patient: 'MRN-245992', status: 'no-pathogen' },
  { id: 'lf-4', title: '4 cultures pending', patient: 'ETA approx. 4 hours', status: 'pending-cultures' },
];
...
const STAKEHOLDER_STATUS: StakeholderStatusItem[] = [
  ...
  { id: 'ss-3', role: 'Nursing In-charge', channel: 'App Push', status: 'pending' },
  { id: 'ss-4', role: 'Microbiology Lab', channel: 'LIS Alert', status: 'sent' },
...
const AUDIT_RECORDS: AuditRecordRow[] = [
  { id: 'ar-1', auditId: 'AUD-031', casePatient: 'Rahul Menon', caseDetail: 'B-12 - Ward 3A', type: 'Hand Hygiene', score: 82, status: 'in_progress' },
  { id: 'ar-2', auditId: 'AUD-030', casePatient: 'Arvind Sharma', caseDetail: 'ICU-03', type: 'PPE Compliance', score: 61, status: 'in_progress' },
  { id: 'ar-3', auditId: 'AUD-029', casePatient: 'Sneha Patil', caseDetail: 'A-04', type: 'Env. Cleaning', score: 94, status: 'completed' },
];
...
const AUDIT_CHECKLIST: AuditChecklistItem[] = [
  { id: 'ac-1', label: 'WHO 5 Moments for Hand Hygiene observed', checked: true },
  { id: 'ac-2', label: 'Alcohol hand rub at point-of-care', checked: true },
  { id: 'ac-3', label: 'Staff training records current', checked: true },
  { id: 'ac-4', label: 'Soap & water available at sink', checked: false, badge: 'A Missing' },
  { id: 'ac-5', label: 'Glove use does not replace hand hygiene', checked: false },
  { id: 'ac-6', label: 'Staff performing HH before patient contact', checked: true, badge: '✓ 4/5' },
];
...
const READY_TO_CLOSE: ReadyToClosePatient[] = [
  { id: 'rtc-1', mrn: 'MRN-245991', patientName: 'Sneha Patil', patientDetail: 'F/28 A-04', pathogen: 'C.diff', days: '10d', auditScore: 94, criteria: 'resolved' },
];
...
const CLOSURE_CRITERIA: ClosureCriterion[] = [
  ...
  { id: 'cc-2', label: 'Isolation maintained ≥72h post last positive', met: true },
...
const CASE_TIMELINE_EVENTS: CaseTimelineEvent[] = [
  { id: 'ct-1', title: 'C.diff Detected', date: '01 Jun · 09:00 AM', source: 'Lab Auto-Flag', description: 'Stool toxin positive. Physician notified. IPD bed A-04.', iconColor: 'info.main' },
  { id: 'ct-2', title: 'Contact Isolation', date: '01 Jun · 10:30 AM', source: 'Nurse Staff', description: 'Room C-05 assigned. Contact sign posted. PPE deployed.', iconColor: 'error.main' },
  { id: 'ct-3', title: 'Stakeholders Notified', date: '01 Jun · 11:00 AM', source: 'IPC Officer', description: 'HOD, Nursing, Lab notified via HMIS. 1 contact screened.', iconColor: 'warning.main' },
  { id: 'ct-4', title: 'Audit Completed — 94%', date: '05 Jun', source: 'Dr. Malhotra', description: 'Env. cleaning compliant. No gaps found.', iconColor: 'info.main' },
  { id: 'ct-5', title: 'Ready for Closure', date: '11 Jun · Awaiting sign-off', source: '', description: '3 negative cultures confirmed. All criteria met.', iconColor: 'success.main' },
];

const CASE_DETAIL_EVENTS: Record<string, CaseDetailEvent[]> = {
  'ic-1': [
    { id: 'cd-1', title: 'MRSA Detected', date: '09 Jun · 08:30 AM', source: 'LIS Auto-Flag', description: 'Blood culture positive. Vancomycin susceptible. Physician Dr. Verma notified immediately.', icon: 'detect' },
    { id: 'cd-2', title: 'Contact Isolation — B-12', date: '09 Jun · 09:30 AM', source: 'Nurse Staff', description: 'Isolation in place. Contact sign posted. Dedicated BP cuff and stethoscope assigned.', icon: 'isolate' },
    { id: 'cd-3', title: 'HOD, IPC, Nursing Notified', date: '09 Jun · 09:45 AM', source: 'IPC Officer', description: 'All stakeholders notified via HMIS + SMS. 2 nearby patients screened.', icon: 'notify' },
    { id: 'cd-4', title: 'Hand Hygiene Audit — 82%', date: '11 Jun', source: 'Dr. Malhotra', description: 'Audit in progress. Gap found: soap dispenser empty. Corrective action triggered.', icon: 'audit' },
  ],
  'ic-2': [
    { id: 'cd-5', title: 'C.diff Detected', date: '08 Jun · 07:45 AM', source: 'Lab Auto-Flag', description: 'Stool toxin positive. Physician notified. Contact precautions initiated.', icon: 'detect' },
    { id: 'cd-6', title: 'Contact Isolation — A-04', date: '08 Jun · 10:00 AM', source: 'Nurse Staff', description: 'Room assigned. Dedicated equipment in place.', icon: 'isolate' },
    { id: 'cd-7', title: 'Stakeholders Notified', date: '08 Jun · 11:30 AM', source: 'IPC Officer', description: 'HOD and nursing notified via HMIS.', icon: 'notify' },
  ],
  'ic-3': [
    { id: 'cd-8', title: 'MRSA Detected', date: '07 Jun · 09:00 AM', source: 'LIS Auto-Flag', description: 'Blood culture positive. Isolation initiated.', icon: 'detect' },
    { id: 'cd-9', title: 'Airborne Isolation — B-08', date: '07 Jun · 02:00 PM', source: 'Nurse Staff', description: 'N95 required. Negative pressure room assigned.', icon: 'isolate' },
    { id: 'cd-10', title: 'COVID-19 retest negative', date: '08 Jun · 02:10 PM', source: 'Lab', description: 'Isolation cleared. Standard precautions resumed.', icon: 'audit' },
  ],
  'ic-4': [
    { id: 'cd-11', title: 'VRE Detected', date: '06 Jun · 08:00 AM', source: 'Lab Auto-Flag', description: 'Urine culture positive. Droplet precautions.', icon: 'detect' },
    { id: 'cd-12', title: 'Droplet Isolation — ICU-03', date: '06 Jun · 10:30 AM', source: 'ICU Staff', description: 'Surgical mask required. Dedicated equipment assigned.', icon: 'isolate' },
  ],
  'ic-5': [
    { id: 'cd-13', title: 'COVID-19 Detected', date: '01 Jun · 09:00 AM', source: 'PCR', description: 'Positive PCR. Airborne isolation initiated.', icon: 'detect' },
    { id: 'cd-14', title: 'Case Closed', date: '05 Jun · 04:00 PM', source: 'Dr. Anand', description: '3 negative tests. All criteria met. Isolation cleared.', icon: 'audit' },
  ],
};

const CASE_EXTRA: Record<string, { admissionDate: string; diagnosis: string; genderAge: string }> = {
  'ic-1': { admissionDate: '08 Jun 2024', diagnosis: 'Community Acquired Pneumonia', genderAge: 'M/34' },
  'ic-2': { admissionDate: '07 Jun 2024', diagnosis: 'C.diff Colitis', genderAge: 'F/28' },
  'ic-3': { admissionDate: '05 Jun 2024', diagnosis: 'MRSA Bacteremia', genderAge: 'M/45' },
  'ic-4': { admissionDate: '06 Jun 2024', diagnosis: 'VRE UTI', genderAge: 'F/52' },
  'ic-5': { admissionDate: '01 Jun 2024', diagnosis: 'COVID-19 Pneumonia', genderAge: 'M/38' },
};

const IPD_PATIENTS = [
  { id: 'ipd-1', mrn: 'MRN-245990', name: 'Rahul Menon', wardBed: 'Ward 3A / B-12' },
  { id: 'ipd-2', mrn: 'MRN-245991', name: 'Sneha Patil', wardBed: 'Ward 1B / A-04' },
  { id: 'ipd-3', mrn: 'MRN-245781', name: 'Aarav Nair', wardBed: 'Ward 3A / B-08' },
  { id: 'ipd-4', mrn: 'MRN-245799', name: 'Meera Joshi', wardBed: 'ICU / ICU-03' },
  { id: 'ipd-5', mrn: 'MRN-245802', name: 'Ravi Iyer', wardBed: 'Isolation Ward / C-05' },
];
...
export default function InfectionControlPage() {
  ...
  const [ppeChecklist, setPpeChecklist] = React.useState<Record<string, boolean>>(
    PPE_CHECKLIST.reduce((acc, item) => ({ ...acc, [item.id]: item.checked }), {})
  );
  const [selectedIsolationRoomId, setSelectedIsolationRoomId] = React.useState<string | null>('iso-1');
  const [sendToChannels, setSendToChannels] = React.useState<Record<string, boolean>>(
    SEND_TO_OPTIONS.reduce((acc, item) => ({ ...acc, [item.id]: item.checked }), {})
  );
  const [selectedAuditId, setSelectedAuditId] = React.useState<string | null>('ar-1');
  const [auditChecklist, setAuditChecklist] = React.useState<Record<string, boolean>>(
    AUDIT_CHECKLIST.reduce((acc, item) => ({ ...acc, [item.id]: item.checked }), {})
  );
  ...
  const [activeTab, setActiveTab] = React.useState<(typeof FLOW_TAB_IDS)[number]>('detect');
  ...
  const handleResolveCase = (caseId: string) => {
    setCases((prev) =>
      prev.map((item) =>
        item.id === caseId
          ? { ...item, status: 'Closed', icStatus: 'Closed' as IcStatus, lastUpdate: 'Just now' }
          : item
      )
    );
  ...
  const handleConfirmCloseCase = () => {
    ...
    if (!closeCaseForm.closingPhysician) {
      setSnackbar({ open: true, message: 'Please enter Closing Physician.', severity: 'info' });
      return;
    }
    if (!closeCaseForm.confirmCriteria) {
      setSnackbar({ open: true, message: 'Please confirm closure criteria.', severity: 'info' });
      return;
    }
  ...
  const handleCreateCase = () => {
    const sel = caseForm.patientSelect
      ? IPD_PATIENTS.find((p) => p.mrn === caseForm.patientSelect || p.name === caseForm.patientSelect)
      : null;
    const [unit, bed] = sel?.wardBed ? sel.wardBed.split(' / ') : ['General Ward', '-'];
    const newCase: InfectionCase = {
      id: `ic-${Date.now()}`,
      patientName: sel?.name || caseForm.patientName || 'New Patient',
      mrn: sel?.mrn || caseForm.mrn || 'MRN-NEW',
      organism: caseForm.suspectedPathogen || caseForm.organism || 'Unknown organism',
      ...
      icStatus: 'Detected',
      status: 'Active',
      risk: (caseForm.priority === 'Critical' ? 'High' : caseForm.priority === 'High' ? 'High' : 'Moderate') as InfectionCase['risk'],
      lastUpdate: 'Just now',
    };
    ...
    setAutoTriggers({ assignIsolation: true, notifyIpc: true, notifyHod: true, scheduleAudit: false, outbreakFlag: false });
  ...
  const openIsolateDialog = (targetCase: InfectionCase) => {
    ...
    setIsolateForm((prev) => ({
      ...
      gloves: true,
      gown: true,
      surgicalMask: targetCase.isolationType === 'Droplet' || targetCase.isolationType === 'Airborne',
  ...
  const handleConfirmIsolation = () => {
    if (!isolateCaseId || !isolateForm.roomId) {
      setSnackbar({ open: true, message: 'Please select an isolation room.', severity: 'info' });
      return;
    }
    const room = AVAILABLE_ISOLATION_ROOMS.find((r) => r.id === isolateForm.roomId);
    if (room) {
      const isoType =
      ...
      setSnackbar({ open: true, message: 'Isolation initiated. Room assigned.', severity: 'success' });
  ...
  const filteredCases = React.useMemo(() => {
    ...
    return cases.filter((c) => c.icStatus === targetStatus);
  }, [cases, activeTab]);

  const flowTabs: CommonTabItem<(typeof FLOW_TAB_IDS)[number]>[] = [
    { id: 'detect', label: `Detect ${tabCounts.detect}`, icon: <SearchIcon /> },
    { id: 'isolate', label: `Isolate ${tabCounts.isolate}`, icon: <HealthAndSafetyIcon /> },
    { id: 'notify', label: `Notify ${tabCounts.notify}`, icon: <NotificationsIcon /> },
    { id: 'audit', label: `Audit ${tabCounts.audit}`, icon: <AssignmentTurnedInIcon /> },
    { id: 'close', label: `Close ${tabCounts.close}`, icon: <CheckCircleIcon /> },
  ];
        ...
        >
          <Stack spacing={1.25}>
            <Stack direction="row" alignItems="center" spacing={0.75}>
              ...
              <Typography variant="body2" color="text.secondary">
                — Jump to related patient workflows
              </Typography>
            </Stack>
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
              ...
              <Button
                size="small"
                variant="outlined"
                startIcon={<HealthAndSafetyIcon sx={{ fontSize: 16 }} />}
              ...
              <Button
                ...
                disabled={!canNavigate('/ipd/orders-tests/lab')}
                onClick={() => router.push(withMrn('/ipd/orders-tests/lab'))}
                sx={{
                  borderColor: alpha(theme.palette.primary.main, 0.4),
                  color: 'primary.main',
                  '&:hover': { borderColor: 'primary.main', bgcolor: alpha(theme.palette.primary.main, 0.06) },
              ...
              <Stack spacing={1.5}>
                  ...
                  <Stack spacing={1.25} sx={{ p: 1.75 }}>
                    ...
                    >
                      ...
                      <Stack direction="row" spacing={1} alignItems="center">
                        <Typography variant="body2" sx={{ color: 'error.main', fontWeight: 600 }}>
                          {isolations.filter((i) => i.status === 'Pending').length} pending action
                        </Typography>
                        <Button
                          variant="contained"
                          size="small"
                          disabled={!canWrite}
                          onClick={() => {
                            const targetCase = cases.find((c) => c.icStatus === 'Detected') ?? cases[0];
                    ...
                    <TableContainer sx={{ borderRadius: 1.5, overflow: 'hidden' }}>
                      <Table size="small">
                        <TableHead>
                          <TableRow>
                            <TableCell sx={TABLE_HEADER_SX}>Room</TableCell>
                            <TableCell sx={TABLE_HEADER_SX}>Patient</TableCell>
                            <TableCell sx={TABLE_HEADER_SX}>Unit</TableCell>
                            <TableCell sx={TABLE_HEADER_SX}>Type</TableCell>
                            <TableCell sx={TABLE_HEADER_SX}>Started</TableCell>
                        ...
                        <TableBody>
                          {isolations.map((iso) => (
                            <TableRow
                              key={iso.id}
                              hover
                              onClick={() => setSelectedIsolationRoomId(iso.id)}
                              sx={{
                                cursor: 'pointer',
                                backgroundColor:
                                  iso.status === 'Pending'
                                    ? alpha(theme.palette.warning.main, 0.08)
                                    : iso.id === selectedIsolationRoomId
                                      ? alpha(theme.palette.primary.main, 0.08)
                                      : 'transparent',
                              }}
                            >
                              <TableCell>{iso.room}</TableCell>
                              <TableCell>
                              ...
                              <TableCell>{iso.unit}</TableCell>
                              <TableCell>
                                <Chip
                                  size="small"
                                  label={iso.type.toUpperCase()}
                                  sx={{
                                    fontWeight: 600,
                                    bgcolor:
                                      iso.type === 'Airborne'
                              ...
                              <TableCell>{iso.startedAt}</TableCell>
                              <TableCell>
                                <Chip
                                  size="small"
                                  icon={
                              ...
                              <TableCell align="right">
                                {iso.status === 'Pending' ? (
                                  ...
                                  <Button
                                    ...
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      handleToggleIsolation(iso.id);
                                    }}
                                  >
                                    {iso.status === 'Cleared' ? 'Reopen' : 'Clear'}
                                  </Button>
                                )}
                              </TableCell>
                            </TableRow>
                ...
                >
                  <Stack spacing={1.25} sx={{ p: 1.75 }}>
                    <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>
                      PPE Checklist — {(() => {
                        const sel = isolations.find((i) => i.id === selectedIsolationRoomId);
                        return sel ? `${sel.room} (${sel.patientName ?? '—'})` : 'Select a room';
                      })()}
                    </Typography>
                    {PPE_CHECKLIST.map((item) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onChange={(_, checked) =>
                            setPpeChecklist((prev) => ({ ...prev, [item.id]: checked }))
                          }
                    ...
                    <Stack direction="row" flexWrap="wrap" gap={1} sx={{ pt: 0.5 }}>
                      <Stack direction="row" alignItems="center" spacing={0.5}>
                        ...
                        <Typography variant="caption">
                          Occupied ({ROOM_MAP_ITEMS.filter((r) => r.status === 'occupied').length})
                        </Typography>
                      </Stack>
                      <Stack direction="row" alignItems="center" spacing={0.5}>
                        <Box
                        ...
                        />
                        <Typography variant="caption">
                          Free ({ROOM_MAP_ITEMS.filter((r) => r.status === 'free').length})
                        </Typography>
                      </Stack>
                      <Stack direction="row" alignItems="center" spacing={0.5}>
                        <Box
                        ...
                        />
                        <Typography variant="caption">
                          Cleaning ({ROOM_MAP_ITEMS.filter((r) => r.status === 'cleaning').length})
                        </Typography>
                      </Stack>
                      <Stack direction="row" alignItems="center" spacing={0.5}>
                        <Box
                        ...
                        />
                        <Typography variant="caption">
                          Maintenance ({ROOM_MAP_ITEMS.filter((r) => r.status === 'maintenance').length})
                        </Typography>
                      </Stack>
                    </Stack>
                  </Stack>
                          ...
                          <Box
                            sx={{
                              ...
                              bgcolor:
                                item.type === 'critical'
                                  ? alpha(theme.palette.error.main, 0.12)
                                  : item.type === 'exposure' || item.type === 'lab-ready'
                                    ? alpha(theme.palette.warning.main, 0.12)
                    ...
                    {SEND_TO_OPTIONS.map((item) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onChange={(_, checked) =>
                            setSendToChannels((prev) => ({ ...prev, [item.id]: checked }))
                          }
                          icon={<CheckBoxOutlineBlankIcon />}
                  ...
                  <Stack spacing={1.25} sx={{ p: 1.75 }}>
                    ...
                    <TableContainer sx={{ borderRadius: 1.5, overflow: 'hidden' }}>
                      <Table size="small">
                        <TableHead>
                          <TableRow>
                            <TableCell sx={TABLE_HEADER_SX}>Audit ID</TableCell>
                            <TableCell sx={TABLE_HEADER_SX}>Case / Patient</TableCell>
                            <TableCell sx={TABLE_HEADER_SX}>Type</TableCell>
                            <TableCell sx={TABLE_HEADER_SX}>Score</TableCell>
                            <TableCell sx={TABLE_HEADER_SX}>Status</TableCell>
                            <TableCell sx={{ ...TABLE_HEADER_SX }} align="right">
                              Action
                            </TableCell>
                          ...
                          {AUDIT_RECORDS.map((row) => (
                            <TableRow
                              ...
                              sx={{
                                cursor: 'pointer',
                                backgroundColor:
                                  row.id === selectedAuditId ? alpha(theme.palette.primary.main, 0.08) : 'transparent',
                              }}
                            >
                              <TableCell>
                                <Typography
                                  ...
                                  sx={{
                                    fontWeight: 600,
                                    color: row.id === selectedAuditId ? 'primary.main' : 'text.primary',
                                  }}
                                >
                                  {row.auditId}
                                </Typography>
                              ...
                              <TableCell>
                                <Typography
                                  ...
                                  sx={{
                                    fontWeight: 600,
                                    color: row.score >= 85 ? 'success.main' : row.score < 70 ? 'error.main' : 'warning.main',
                                  }}
                                >
                                  {row.score}%
                                </Typography>
                              ...
                              <TableCell>
                                <Chip
                                  ...
                                  icon={
                                    <Box
                                      sx={{
                                        ...
                                        height: 6,
                                        borderRadius: '50%',
                                        bgcolor: row.status === 'completed' ? 'success.main' : 'secondary.main',
                                      }}
                                    />
                                  }
                                  ...
                                  sx={{
                                    ...
                                    color: row.status === 'completed' ? 'success.dark' : 'secondary.dark',
                                    '& .MuiChip-icon': { ml: 0.5 },
                                  }}
                                />
                              </TableCell>
                                  ...
                                  <Stack direction="row" spacing={0.5} justifyContent="flex-end">
                                    <Button
                                      ...
                                      onClick={(e) => {
                                        ...
                                        setAuditForm((prev) => ({
                                          ...prev,
                                          linkedPatient: `${row.casePatient} · ${row.caseDetail}`,
                                          wardArea: row.caseDetail,
                    ...
                    {AUDIT_CHECKLIST.map((item) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onChange={(_, checked) =>
                            setAuditChecklist((prev) => ({ ...prev, [item.id]: checked }))
                          }
                          icon={<CheckBoxOutlineBlankIcon />}
                          checkedIcon={<CheckBoxIcon sx={{ color: 'success.main' }} />}
                          sx={{ p: 0.25 }}
                        ...
                        {item.badge && (
                          <Chip
                            ...
                            sx={{
                              fontSize: '0.65rem',
                              height: 20,
                              bgcolor: item.badge.includes('Missing') ? alpha(theme.palette.warning.main, 0.12) : alpha(theme.palette.success.main, 0.12),
                              color: item.badge.includes('Missing') ? 'warning.dark' : 'success.dark',
                            }}
                          />
                        )}
                      </Stack>
                      ...
                      <Box key={item.id}>
                        <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 0.5 }}>
                          ...
                          <Typography
                            ...
                            sx={{
                              fontWeight: 600,
                              color: item.score >= 85 ? 'success.main' : item.score < 70 ? 'error.main' : 'warning.main',
                            }}
                          >
                            {item.score}%
                          </Typography>
                ...
                >
                  <Stack spacing={1.25} sx={{ p: 1.75 }}>
                    ...
                    >
                      ...
                      <Typography variant="body2" color="text.secondary">
                        {READY_TO_CLOSE.length} case meets criteria
                      </Typography>
                    </Stack>
                    <TableContainer sx={{ borderRadius: 1.5, overflow: 'hidden' }}>
                      <Table size="small">
                        <TableHead>
                          <TableRow>
                            ...
                            <TableCell sx={TABLE_HEADER_SX}>Days</TableCell>
                            <TableCell sx={TABLE_HEADER_SX}>Audit</TableCell>
                            <TableCell sx={TABLE_HEADER_SX}>Criteria</TableCell>
                            <TableCell sx={{ ...TABLE_HEADER_SX }} align="right">
                              Action
                            </TableCell>
                          </TableRow>
                        ...
                        <TableBody>
                          {READY_TO_CLOSE.map((row) => (
                            <TableRow key={row.id} hover>
                              <TableCell>
                                <Typography
                                  variant="body2"
                                  sx={{ fontWeight: 600, color: 'primary.main', textDecoration: 'underline', cursor: 'pointer' }}
                                  onClick={() => router.push(withMrn('/patients/profile'))}
                                >
                                  {row.mrn}
                                </Typography>
                              ...
                              <TableCell align="right">
                                <Button
                                  ...
                                  disabled={!canWrite}
                                  onClick={() => {
                                    const c = cases.find((c) => c.mrn === row.mrn);
                                    if (c) openCloseCaseDialog(c);
                                  }}
                                  sx={{ textTransform: 'none', fontWeight: 600 }}
                                >
                                  Close Case
                      ...
                      >
                        ...
                        >
                          {evt.iconColor === 'success.main' ? (
                            ...
                            <HealthAndSafetyIcon sx={{ fontSize: 18, color: 'error.main' }} />
                          ) : evt.iconColor === 'warning.main' ? (
                            <NotificationsIcon sx={{ fontSize: 18, color: 'warning.main' }} />
                          ) : (
                            <SearchIcon sx={{ fontSize: 18, color: 'info.main' }} />
                          )}
                        </Box>
                        <Stack spacing={0.25} sx={{ flex: 1, minWidth: 0 }}>
                          <Typography variant="body2" sx={{ fontWeight: 600 }}>
              ...
              <Stack spacing={1.25} sx={{ p: 1.75 }}>
                ...
                >
                  <Stack direction="row" alignItems="center" spacing={1}>
                    ...
                    <Chip size="small" label="From IPD" variant="outlined" sx={{ fontWeight: 600 }} />
                  </Stack>
                  <Stack direction="row" spacing={1} alignItems="center">
                    <Select
                      size="small"
                        ...
                        >
                          <TableCell>
                            <Typography
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                router.push(withMrn('/patients/profile'));
                              }}
                            >
                              {item.mrn}
                            </Typography>
                            ...
                            <Stack direction="row" alignItems="center" spacing={0.5}>
                              <Box
                                sx={{
                                  ...
                                  borderRadius: '50%',
                                  bgcolor:
                                    item.organism === 'MRSA' || item.organism === 'VRE'
                                      ? 'error.main'
                                  ...
                                  sx={{
                                    ...
                                    bgcolor:
                                      item.icStatus === 'Isolating'
                                        ? 'error.main'
                                        : item.icStatus === 'Notified' || item.icStatus === 'Detected'
                                          ? 'warning.main'
                              ...
                              {item.icStatus === 'Isolating' && (
                                <Button
                                  ...
                                  onClick={(e) => {
                                    ...
                                    setCases((prev) =>
                                      prev.map((c) =>
                                        c.id === item.id ? { ...c, icStatus: 'Notified' as IcStatus } : c
                                      )
                                    );
                                  }}
                                >
                              ...
                              {item.icStatus === 'Notified' && (
                                <Button
                                  ...
                                  onClick={(e) => {
                                    ...
                                    setCases((prev) =>
                                      prev.map((c) =>
                                        c.id === item.id ? { ...c, icStatus: 'In Audit' as IcStatus } : c
                                      )
                                    );
                                  }}
                                >
              ...
              <Stack spacing={1.25}>
                ...
                {DETECTION_SOURCES.map((src) => (
                  <Box key={src.id}>
                    ...
                    <LinearProgress
                      variant="determinate"
                      value={src.id === 'ds-1' ? 50 : src.id === 'ds-2' ? 27 : 23}
                      sx={{
                        height: 6,
                        borderRadius: 1,
                        bgcolor: alpha(theme.palette.primary.main, 0.08),
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={7}>
            <Autocomplete
              ...
              value={IPD_PATIENTS.find((p) => p.mrn === caseForm.patientSelect) ?? null}
              onChange={(_, val) => {
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <BedIcon sx={{ fontSize: 16, color: 'text.disabled' }} />
                  </InputAdornment>
                ),
              }}
              sx={{
        ...
        <Grid container spacing={2} sx={{ width: '100%' }}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <TextField
              ...
              onChange={(e) =>
                setCaseForm((prev) => ({ ...prev, suspectedPathogen: e.target.value }))
              }
              size="small"
              fullWidth
            ...
            >
              ...
              {['MRSA', 'VRE', 'C.diff', 'COVID-19', 'ESBL', 'Other'].map((p) => (
          ...
          <Grid item xs={12} sm={6} md={4}>
            <TextField
              ...
              onChange={(e) =>
                setCaseForm((prev) => ({ ...prev, isolationLevel: e.target.value }))
              }
              size="small"
              fullWidth
              sx={{ '& .MuiOutlinedInput-root': { borderRadius: 1.5 } }}
          ...
          <Grid item xs={12} sm={6} md={4}>
            <TextField
              ...
              onChange={(e) =>
                setCaseForm((prev) => ({ ...prev, detectionSource: e.target.value }))
              }
              size="small"
              fullWidth
              sx={{ '& .MuiOutlinedInput-root': { borderRadius: 1.5 } }}
            >
              <MenuItem value="Lab Auto-Flag (LIS)">Lab Auto-Flag (LIS)</MenuItem>
          ...
          <Grid item xs={12} md={8} lg={4} >
            <TextField
              ...
              onChange={(e) =>
                setCaseForm((prev) => ({ ...prev, reportingPhysician: e.target.value }))
              }
          ...
          <Grid item xs={12} md={4} lg={4} >
            <TextField
              ...
              onChange={(e) =>
                setCaseForm((prev) => ({ ...prev, dateDetected: e.target.value }))
              }
          ...
          <Grid item xs={12} md={12} lg={12} xl={12}>
            <TextField
              ...
              onChange={(e) =>
                setCaseForm((prev) => ({ ...prev, clinicalNotes: e.target.value }))
              }
      ...
      >
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={6}>
            <Stack spacing={0.5}>
              {[
                { key: 'assignIsolation', label: 'Assign Isolation Room' },
                ...
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      checked={autoTriggers[key as keyof typeof autoTriggers]}
                      onChange={(_, v) =>
...
/>
      ...
      <CommonDialog
              ...
              >
                <Stack direction="row" spacing={2} alignItems="flex-start" flexWrap="wrap">
                  ...
                  <Stack spacing={0.5} sx={{ flex: 1, minWidth: 0 }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {CASE_EXTRA[selectedCase.id]?.genderAge ?? '—'} • {selectedCase.mrn} • {selectedCase.unit} • Bed{' '}
                      {selectedCase.bed}
                    </Typography>
                    <Typography variant="caption" color="text.secondary">
                      Admitted: {CASE_EXTRA[selectedCase.id]?.admissionDate ?? '—'}
                    </Typography>
                    <Typography variant="caption" color="text.secondary">
                      ...
                      evt.icon === 'detect'
                        ...
                        : evt.icon === 'isolate'
                          ...
                          : evt.icon === 'notify'
                            ...
                            : 'info.main';
                    return (
                      <Stack key={evt.id} direction="row" spacing={1.5} sx={{ position: 'relative', ml: -2.5 }}>
                        <Stack
                          sx={{
                            width: 32,
                            height: 32,
                            ...
                            boxShadow: '0 0 0 1px ' + alpha(theme.palette.grey[500], 0.2),
                          }}
                        >
        ...
        actions={
          <Stack direction="row" spacing={1.5} alignItems="center" width="100%" flexWrap="wrap">
            <Button
              variant="outlined"
              color="inherit"
      ...
      <CommonDialog
        ...
        subtitle={
          isolateCaseId
            ? (() => {
                ...
                return c ? `${c.patientName} · ${c.mrn} · ${c.organism} · ${c.bed}` : undefined;
              })()
            : undefined
        }
        icon={
              ...
              return (
                <Stack spacing={2} sx={{ mt: 1 }}>
                  ...
                  >
                    <Stack direction="row" spacing={2} alignItems="center" flexWrap="wrap">
                      ...
                      <Stack spacing={0.5} sx={{ flex: 1, minWidth: 0 }}>
                        ...
                        <Typography variant="body2" color="text.secondary">
                          {CASE_EXTRA[isolateCase.id]?.genderAge ?? '—'} · {isolateCase.mrn} · {isolateCase.unit} · Bed{' '}
                          {isolateCase.bed}
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
                          Pathogen: {isolateCase.organism} Current: Detected — Isolation Pending
                        </Typography>
                      </Stack>
                      <Chip
                        size="small"
                  ...
                  <TextField
                    ...
                    onChange={(e) => setIsolateForm((prev) => ({ ...prev, roomId: e.target.value }))}
                    size="small"
                    fullWidth
                    sx={{ '& .MuiOutlinedInput-root': { borderRadius: 1.5 } }}
                  >
                  ...
                  <TextField
                    ...
                    onChange={(e) => setIsolateForm((prev) => ({ ...prev, isolationType: e.target.value }))}
                    size="small"
                    fullWidth
                    sx={{ '& .MuiOutlinedInput-root': { borderRadius: 1.5 } }}
                  >
                    <MenuItem value="Contact Precautions">Contact Precautions</MenuItem>
                    <MenuItem value="Droplet Precautions">Droplet Precautions</MenuItem>
                    <MenuItem value="Airborne Precautions">Airborne Precautions</MenuItem>
                    <MenuItem value="Standard Precautions">Standard Precautions</MenuItem>
                  </TextField>
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            ...
                            onChange={(e) => setIsolateForm((prev) => ({ ...prev, gloves: e.target.checked }))}
                            size="small"
                          />
                        }
                        label="Gloves"
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            ...
                            onChange={(e) => setIsolateForm((prev) => ({ ...prev, gown: e.target.checked }))}
                            size="small"
                          />
                        }
                        label="Gown"
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            ...
                            onChange={(e) => setIsolateForm((prev) => ({ ...prev, surgicalMask: e.target.checked }))}
                            size="small"
                          />
                        }
                        label="Surgical Mask"
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            ...
                            onChange={(e) => setIsolateForm((prev) => ({ ...prev, n95: e.target.checked }))}
                            size="small"
                          />
                        }
                        label="N95"
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            ...
                            onChange={(e) => setIsolateForm((prev) => ({ ...prev, faceShield: e.target.checked }))}
                            size="small"
                          />
                        }
                        label="Face Shield"
                  ...
                  <TextField
                    ...
                    onChange={(e) => setIsolateForm((prev) => ({ ...prev, notes: e.target.value }))}
        ...
        actions={
          <Stack direction="row" spacing={1.5} alignItems="center" sx={{justifyContent:"flex-end"}}>
      ...
      <CommonDialog
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => setAuditForm((prev) => ({ ...prev, linkedPatient: e.target.value }))}
                  size="small"
                  fullWidth
                  sx={{ '& .MuiOutlinedInput-root': { borderRadius: 1.5 } }}
                >
                  ...
                  {auditForm.linkedPatient &&
                    !cases.some((c) => `${c.patientName} · ${c.bed}` === auditForm.linkedPatient) && (
                      <MenuItem value={auditForm.linkedPatient}>{auditForm.linkedPatient}</MenuItem>
                    )}
                  {cases
                    .filter((c) => c.status === 'Active' || c.icStatus === 'In Audit')
                    .map((c) => (
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => setAuditForm((prev) => ({ ...prev, wardArea: e.target.value }))}
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => setAuditForm((prev) => ({ ...prev, score: e.target.value }))}
                  placeholder="e.g. 85"
                  size="small"
                  fullWidth
              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  ...
                  <MenuItem value="Isolation Compliance">Isolation Compliance</MenuItem>
                </TextField>
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => setAuditForm((prev) => ({ ...prev, leadAuditor: e.target.value }))}
                  placeholder="Name / Employee ID"
                  size="small"
                  fullWidth
                  sx={{ '& .MuiOutlinedInput-root': { borderRadius: 1.5 } }}
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => setAuditForm((prev) => ({ ...prev, observations: e.target.value }))}
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => setAuditForm((prev) => ({ ...prev, correctiveActions: e.target.value }))}
        ...
        actions={
          <>
            <Button variant="outlined" color="inherit" onClick={() => setAuditDialogOpen(false)} sx={{ textTransform: 'none', fontWeight: 600 }}>
              Cancel
            </Button>
            <Button variant="contained" color="primary" disabled={!canWrite} onClick={handleLogAudit} sx={{ textTransform: 'none', fontWeight: 600 }}>
              Save Audit
            </Button>
          </>
        }
          ...
          closeCaseId ? (
            <Stack spacing={2} sx={{ mt: 1 }}>
              ...
              <TextField
                ...
                onChange={(e) => setCloseCaseForm((prev) => ({ ...prev, closingPhysician: e.target.value }))}
                placeholder="Name / Employee ID"
                size="small"
                fullWidth
                sx={{ '& .MuiOutlinedInput-root': { borderRadius: 1.5 } }}
              ...
              <TextField
                ...
                onChange={(e) => setCloseCaseForm((prev) => ({ ...prev, closureDate: e.target.value }))}
                placeholder="dd / mm / yyyy"
                size="small"
                fullWidth
                InputProps={{
              ...
              <TextField
                ...
                onChange={(e) => setCloseCaseForm((prev) => ({ ...prev, finalSummary: e.target.value }))}
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={(e) => setCloseCaseForm((prev) => ({ ...prev, confirmCriteria: e.target.checked }))}
                    color="primary"
                  />
                }
                label="I confirm all closure criteria are verified and this case is safe to close."
                sx={{ alignItems: 'flex-start', '& .MuiFormControlLabel-label': { fontWeight: 500 } }}
              />
            </Stack>
          ) : null
        }
