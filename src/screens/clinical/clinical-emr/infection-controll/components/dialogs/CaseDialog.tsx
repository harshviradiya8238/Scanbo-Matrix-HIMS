...
const CaseDialog: React.FC<CaseDialogProps> = ({
  ...
  const [caseForm, setCaseForm] = React.useState<CaseForm>({
    patientSelect: null,
    wardBed: "",
    suspectedPathogen: "",
  ...
  const [autoTriggers, setAutoTriggers] = React.useState<AutoTriggers>({
  ...
  const onCreate = () => {
    handleCreateCase({ caseForm, autoTriggers });
  };
