...
export const CLINICAL_MODULES: ClinicalModuleDefinition[] = [
  ...
  },
  {
    ...
    area: 'Billing & Claims',
    description:
      'Revenue cycle command center for charge capture, coding, invoices, claims, denials, collections, and refunds.',
    audience: ['Billing Team', 'Insurance Desk', 'Finance Staff', 'Auditors'],
